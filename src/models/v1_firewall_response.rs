...
impl V1FirewallResponse {
    pub fn new(bios: crate::models::V1MachineBios, events: crate::models::V1MachineRecentProvisioningEvents, hardware: crate::models::V1MachineHardware, id: String, ledstate: crate::models::V1ChassisIdentifyLedState, liveliness: String, state: crate::models::V1MachineState, tags: Vec<String>) -> V1FirewallResponse {
        V1FirewallResponse {
            allocation: None,
            bios,
            changed: None,
