...
pub struct V1NetworkResponse {
    ...
    pub underlay: bool,
    #[serde(rename = "usage")]
    pub usage: crate::models::V1NetworkUsage,
...
impl V1NetworkResponse {
    pub fn new(destinationprefixes: Vec<String>, id: String, nat: bool, prefixes: Vec<String>, privatesuper: bool, underlay: bool, usage: crate::models::V1NetworkUsage) -> V1NetworkResponse {
        V1NetworkResponse {
            changed: None,
            created: None,
            description: None,
