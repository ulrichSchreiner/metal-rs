...
pub struct V1MachineAllocateRequest {
...
impl V1MachineAllocateRequest {
    pub fn new(imageid: String, partitionid: String, projectid: String, sizeid: String, ssh_pub_keys: Vec<String>) -> V1MachineAllocateRequest {
