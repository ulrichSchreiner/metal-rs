...
pub struct V1MachineIpmiResponse {
...
impl V1MachineIpmiResponse {
    pub fn new(bios: crate::models::V1MachineBios, events: crate::models::V1MachineRecentProvisioningEvents, hardware: crate::models::V1MachineHardware, id: String, ipmi: crate::models::V1MachineIpmi, ledstate: crate::models::V1ChassisIdentifyLedState, liveliness: String, state: crate::models::V1MachineState, tags: Vec<String>) -> V1MachineIpmiResponse {
